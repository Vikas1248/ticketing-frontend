      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-5">
        ...
        <div>
          ...
          <input
            ...
            value={email}
            disabled
            className="w-full mt-1 rounded-lg border border-slate-300 bg-slate-100 px-4 py-2 text-sm text-slate-500 cursor-not-allowed"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full mt-1 rounded-lg border border-slate-300 px-4 py-2 text-sm"
          />
        </div>
